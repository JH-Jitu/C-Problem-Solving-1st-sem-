...
public:
  void readstudent()
  {
	  cout<<"\n\n Enter your Roll Number :";cin>>roll;
	  cout<<"\n Enter Your Average Mark( Out of hundred ) :";cin>>avmark;
  }
  int getroll()
  {
	  return(roll);
		...
		cin>>Ru;
		   for (int i=0; i<60;++i)
		   {
			   if (stu[i].getroll()==Ru)
				{
					flag=0;
					cout<<"\n\n\n Mark of ";stu[i].prtname();cout<<" is "<<stu[i].getmark();
			    }
		   }
		   if(flag)
...
case 99 :
		...
		cout<<"\n\n\n\a"<<"\t\a\a Task accomplished Successfully !";
		}
		else
